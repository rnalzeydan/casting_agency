...
class CastingAgencyTestCase(unittest.TestCase):
    ...
    def test_delete_actor(self):
        res = self.client().delete('/actors/1',  headers={"Authorization": director_token})
        data = json.loads(res.data)
    ...
    def test_modify_actor(self):
        res = self.client().patch('/actors/12', json=self.edit_actor, headers={"Authorization": director_token})
        data = json.loads(res.data)
    ...
    def test_modify_movie(self):
        res = self.client().patch('/movies/12', json=self.edit_movie,  headers={"Authorization": director_token})
        data = json.loads(res.data)
    ...
    def test_404_delete_movie(self):
        res = self.client().delete('/movie/1000',  headers={"Authorization": producer_token})
        data = json.loads(res.data)
    ...
    def test_403_post_movie(self):
        res = self.client().post('/movies',  json=self.new_movie, headers={"Authorization": director_token})
        data = json.loads(res.data)
    ...
    def test_404_patch_actor(self):
        res = self.client().patch('/actor/1000', json=self.edit_actor, headers={"Authorization": producer_token})
        data = json.loads(res.data)
    ...
    def test_404_patch_movie(self):
        res = self.client().patch('/movie/1000',  json=self.edit_movie, headers={"Authorization": producer_token})
        data = json.loads(res.data)
